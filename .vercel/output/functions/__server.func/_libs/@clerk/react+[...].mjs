...
import { A as reverificationError, D as resolveAuthState, E as createCheckAuthorization, F as ClerkRuntimeError, M as getEnvVariable, N as buildErrorThrower, O as validateReverificationConfig, P as isClerkAPIResponseError, d as proxyUrlToAbsoluteURL, f as retry, g as createDevOrStagingUrlCache, h as isDevelopmentEnvironment, k as isReverificationHint, l as isProxyUrlRelative, o as deprecated, p as eventMethodCalled, s as addClerkPrefix, u as isValidProxyUrl, y as parsePublishableKey } from "../clerk__backend+clerk__shared.mjs";
...
function useOAuthConsent(params) {
	...
	clerk.telemetry?.record(eventMethodCalled(HOOK_NAME$4));
...
function useOrganizationCreationDefaults(params = {}) {
	...
	clerk.telemetry?.record(eventMethodCalled(HOOK_NAME$3));
...
//#endregion
//#region node_modules/@clerk/react/dist/hooks-74kNS3WZ.mjs
...
function useClerkSignal(signal) {
	...
	switch (signal) {
		...
		case "signUp":
			...
			break;
		case "waitlist": clerk.telemetry?.record(eventMethodCalled("useWaitlist", { apiVersion: "2025-11" }));
	}
	const subscribe = (0, import_react.useCallback)((callback) => {
		if (!clerk.loaded) return () => {};
		return clerk.__internal_state.__internal_effect(() => {
...
*/
var versionSelector = (clerkJSVersion, packageVersion = "6.30.1") => {
...
//#endregion
//#region node_modules/@clerk/shared/dist/internal/clerk-js/windowNavigate.mjs
...
//#endregion
//#region node_modules/@clerk/react/dist/ClerkProvider-CiYDNhDY.mjs
	...
	buildCheckoutProxy(params) {
		...
		return {
			...
			checkout: {
				...
				update: this.gateMethod(target, "update"),
	...
	*/
	...
	constructor(options) {
		...
		this.__internal_windowNavigate = (to, opts) => {
			...
			if (!inBrowser()) return;
			windowNavigate(to, { allowedProtocols: opts?.useStaticAllowlistOnly ? ALLOWED_PROTOCOLS : [...ALLOWED_PROTOCOLS, ...this.options.allowedRedirectProtocols ?? []] });
		};
		this.setProtectAssertion = (assertion) => {
			...
			else this.premountMethodCalls.set("setProtectAssertion", callback);
		};
		...
		this.replayInterceptedInvocations = (clerkjs) => {
			...
			if (this.preopenInviteMembers !== null) clerkjs.openInviteMembers(this.preopenInviteMembers);
		...
		this.openInviteMembers = (props) => {
			if (this.clerkjs && this.loaded) this.clerkjs.openInviteMembers(props);
			else this.preopenInviteMembers = props;
		};
		this.closeInviteMembers = () => {
			if (this.clerkjs && this.loaded) this.clerkjs.closeInviteMembers();
			else this.preopenInviteMembers = null;
		};
		...
		this.__internal_resumeAfterProtectCheck = async (params, customNavigate) => {
			const callback = () => {
				const clerkjs = this.clerkjs;
				if (typeof clerkjs?.__internal_resumeAfterProtectCheck !== "function") return;
				clerkjs.__internal_resumeAfterProtectCheck(params, customNavigate)?.catch(() => {});
			};
			if (this.clerkjs && this.loaded) callback();
			else this.premountMethodCalls.set("__internal_resumeAfterProtectCheck", callback);
		};
...
function computeReactVersionCompatibility() {
	try {
		return isVersionCompatible("19.2.8", [
			[
				18,
				0,
				-1,
...
function ClerkProviderGuard(props) {
	if (import_react.useContext(ClerkInstanceContext)) errorThrower$1.throw(multipleClerkProvidersError);
	return /* @__PURE__ */ import_react.createElement(ClerkProviderBase, props);
}
var ClerkProvider = ClerkProviderGuard;
...
var dist_exports = /* @__PURE__ */ __exportAll({
	...
	useOAuthConsent: () => useOAuthConsent,
...
if (globalThis.__clerkSharedModules) {
	...
	if (existingVersion && existingVersion !== "19.2.8") console.warn(`[@clerk/ui/register] React version mismatch detected. Already registered: ${existingVersion}, current import: 19.2.8. This may cause issues with the shared @clerk/ui variant.`);
...
//#endregion
export { OrganizationList as a, SignUp as c, require_react_dom as d, require_jsx_runtime as f, useRoutingProps as i, UserProfile as l, getToken as n, OrganizationProfile as o, require_react as p, InternalClerkProvider as r, SignIn as s, dist_exports as t, QueryClient as u };
